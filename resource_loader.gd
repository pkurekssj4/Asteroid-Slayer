...
const PRELOADED_RESOURCES: Dictionary = {
	...
	"round_explosion": preload("res://round_explosion.tscn"),
	"cross_explosion": preload("res://cross_explosion.tscn"),
	"ordinary_projectile_explosion_particles": preload("res://ordinary_projectile_explosion_particles.tscn"),
	"orbital_strike_projectile_explosion_particles": preload("res://structures/cannon/orbital_strike_projectile_explosion_particles.tscn"),
	"orbital_strike_projectile_following_particles": preload("res://structures/cannon/orbital_strike_projectile_following_particles.tscn"),
	"projectile": preload("res://structures/cannon/projectile.tscn"),
	"muzzle_flash": preload("res://structures/cannon/muzzle_flash.tscn"),
	"muzzle_flash_particles": preload("res://structures/cannon/muzzle_flash_particles.tscn"),
	...
	"ordinary_asteroid_following_particles": preload("res://asteroids/ordinary_asteroid_following_particles.tscn"),
	"ordinary_asteroid_following_particles_smoke": preload("res://asteroids/ordinary_asteroid_following_particles_smoke.tscn"),
	"ribbons_asteroid_following_particles": preload("res://asteroids/ribbons_asteroid_following_particles.tscn"),
	"shockwave_asteroid_pulsing": preload("res://asteroids/shockwave_asteroid_pulsing.tscn"),
	"following_gas_particles": preload("res://asteroids/following_gas_particles.tscn"),
	"following_snow_particles": preload("res://asteroids/following_snow_particles.tscn"),
	"plasma_asteroid_following_particles": preload("res://asteroids/plasma_asteroid_following_particles.tscn"),
	"gravity_well_rings": preload("res://abilities/gravity_well_rings.tscn"),
	"gravity_well_particles": preload("res://abilities/gravity_well_particles.tscn"),
...
const PRELOADED_SCRIPTS: Dictionary[String, Script] = {
	...
	"laser_turrets_ray_caster": preload("res://structures/laser_turret/ray_caster.gd"),
	"pulse_barriers_shockwave": preload("res://structures/pulse_barrier/shockwave.gd"),
